...
export const NODE_DEFINITIONS = [
  ...
  },
  {
    ...
    iconKey: 'globe',
    color: '#2563EB',
    defaults: { headless: false, profileMode: 'isolated', userDataDir: '', profileDirectory: 'Default' },
    schema: [
      { key: 'profileMode', label: 'Profile Mode', type: 'select', options: ['isolated', 'user'],
        hint: 'isolated = clean session. user = your real Chrome profile (logins/cookies/extensions). Close Chrome first — it locks the profile while running.' },
      { key: 'userDataDir', label: 'User Data Dir (optional)', type: 'text', placeholder: 'blank = your real Chrome',
        hint: 'Only for "user" mode. Blank = auto-detect real Chrome. Custom path = dedicated persistent profile.' },
      { key: 'profileDirectory', label: 'Profile Directory', type: 'text', placeholder: 'Default',
        hint: 'Chrome profile to load when User Data Dir is blank (e.g. Default, Profile 1).' },
  ...
  // ══ Tier 5 — Vision / Surface Automation (Citrix / RDP / VNC) ══
  {
    type: 'captureScreen', label: 'Capture Screen', category: 'Vision',
    description: 'Save a screenshot (full screen or region) to a file', iconKey: 'exists', color: '#0D9488',
    ...
    schema: [
      ...
      { key: 'filePath',       label: 'File Path (optional)', type: 'text', placeholder: 'auto if blank' },
      { key: 'outputVariable', label: 'Output Variable', type: 'text', placeholder: 'screenshotPath' },
    ],
    hasInput: true, hasOutput: true,
  },
  {
    type: 'clickImage', label: 'Click Image', category: 'Vision',
    description: 'Find a template image on screen and click it', iconKey: 'mouse', color: '#0D9488',
  ...
  {
    type: 'waitImage', label: 'Wait Image', category: 'Vision',
    description: 'Wait until a template image appears or disappears', iconKey: 'waitLoad', color: '#0D9488',
  ...
  {
    type: 'imageExists', label: 'Image Exists', category: 'Vision',
    description: 'Check whether a template image is on screen (boolean)', iconKey: 'exists', color: '#0D9488',
  ...
  {
    type: 'clickText', label: 'Click Text', category: 'Vision',
    description: 'OCR the screen, find text and click it', iconKey: 'getText', color: '#0D9488',
  ...
  {
    type: 'readText', label: 'Read Text', category: 'Vision',
    description: 'OCR a region (or full screen) into a variable', iconKey: 'getText', color: '#0D9488',
